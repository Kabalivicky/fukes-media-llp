  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-hidden">
      ...
      >
        ...
        <FloatingElements variant="mixed" density="medium" colorScheme="mixed" />
        
        {/* Background effects */}
        <div className="absolute inset-0 pointer-events-none">
          <motion.div 
            className="absolute top-1/3 left-1/4 w-96 h-96 bg-gradient-radial from-primary/10 to-transparent rounded-full blur-3xl"
            animate={{
              scale: [1, 1.2, 1],
              opacity: [0.5, 0.8, 0.5],
            }}
          ...
          />
          <motion.div 
            className="absolute bottom-1/3 right-1/4 w-80 h-80 bg-gradient-radial from-secondary/10 to-transparent rounded-full blur-3xl"
            animate={{
              scale: [1.2, 1, 1.2],
              opacity: [0.8, 0.5, 0.8],
            }}
        ...
        <SectionWrapper withDivider>
          <StaggerReveal className="grid md:grid-cols-2 gap-8" staggerDelay={0.15}>
            {services.map((service) => (
              <Card key={service.id} className="group hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 border-border/50 hover:border-primary/30 overflow-hidden backdrop-blur-sm bg-card/80">
            ...
            {processSteps.map((phase, index) => (
              <LiquidReveal key={phase.step} delay={index * 0.15} direction="left">
                ...
                >
                  ...
                  <Card className="flex-1 hover:shadow-lg transition-all duration-300 backdrop-blur-sm bg-card/80">
      ...
      <ParallaxSection speed={0.4} rotate className="relative">
        <FloatingElements variant="circles" density="low" colorScheme="accent" />
