  ...
  return (
    ...
    >
      <div className="flex items-center mb-4">
        <div className="w-14 h-14 rounded-md bg-gradient-to-br from-primary/10 to-primary/20 flex items-center justify-center shrink-0 mr-4 border border-primary/10" aria-hidden="true">
