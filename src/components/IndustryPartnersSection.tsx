    ...
    <section className="py-16 bg-black/30">
      <div className="container mx-auto px-4">
        ...
        <div className="space-y-12">
              ...
              {platinumSponsors.map((sponsor, index) => (
                <div key={index} className="glass p-6 rounded-xl hover:bg-white/5 transition">
                  <div className="flex flex-col md:flex-row items-center gap-6">
                    <div className="w-full md:w-1/3 bg-gradient-to-r from-amber-500 to-amber-600 p-8 rounded-lg flex items-center justify-center">
                      <span className="text-3xl font-bold text-white">{sponsor.name}</span>
                    </div>
              ...
              {goldSponsors.map((sponsor, index) => (
                <div key={index} className="glass p-6 rounded-xl hover:bg-white/5 transition h-full">
                  <div className="flex flex-col h-full">
                    <div className="bg-gradient-to-r from-amber-400 to-amber-500 p-6 rounded-lg flex items-center justify-center mb-4">
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {silverSponsors.map((sponsor, index) => (
                <div key={index} className="glass p-6 rounded-xl hover:bg-white/5 transition h-full">
                  <div className="flex flex-col h-full">
                    <div className="bg-gradient-to-r from-gray-400 to-gray-500 p-4 rounded-lg flex items-center justify-center mb-4">
          ...
          <div className="glass rounded-xl p-6 text-center max-w-2xl mx-auto">
